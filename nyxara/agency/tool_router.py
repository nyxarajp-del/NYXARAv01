...
INTENT_CUES: Dict[str, Tuple[str, ...]] = {
    ...
    "read_file": ("file", "contents", "open file", "read file", "cat"),
    "read_file_bytes": ("binary file", "read bytes", "raw file", "base64 file"),
    "list_dir": ("list directory", "ls", "folder contents", "list files", "dir"),
    "path_stat": ("stat", "file info", "file size", "metadata", "permissions of"),
    "path_exists": ("exists", "is there a file", "does the file"),
    "find_files": ("find", "locate", "search files", "glob", "which files"),
    "search_in_files": ("grep", "search in", "find text", "search contents", "look for text"),
    "disk_usage": ("disk space", "disk usage", "free space", "how much space"),
    "write_file_bytes": ("write binary", "save bytes", "write base64"),
    "make_dir": ("mkdir", "create folder", "create directory", "make directory"),
    "copy_path": ("copy", "duplicate", "cp"),
    "move_path": ("move", "rename", "mv"),
    "delete_file": ("delete", "remove", "rm", "erase", "delete file"),
    "delete_dir": ("delete folder", "remove directory", "rmdir", "delete directory", "rm -r"),
...
_CLASS = {
    ...
    "read_file": "filesystem read", "read_file_bytes": "filesystem read (binary)",
    "list_dir": "filesystem list", "path_stat": "filesystem stat",
    "path_exists": "filesystem check", "find_files": "filesystem find",
    "search_in_files": "filesystem search", "disk_usage": "filesystem usage",
    "write_file_bytes": "filesystem write (binary)", "make_dir": "filesystem mkdir",
    "copy_path": "filesystem copy", "move_path": "filesystem move",
    "delete_file": "filesystem delete", "delete_dir": "filesystem delete (tree)",
}
