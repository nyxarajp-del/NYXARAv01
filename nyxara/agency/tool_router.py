...
INTENT_CUES: Dict[str, Tuple[str, ...]] = {
    ...
    "read_bytes": ("binary", "raw bytes", "bytes of", "image bytes", "read binary"),
    "stat_path": ("stat", "metadata", "file info", "size of", "modified", "permissions of"),
    "path_exists": ("exists", "is there a file", "does the file", "present"),
    "walk_dir": ("walk", "recursively", "tree", "all files under", "traverse"),
    "glob_paths": ("glob", "find files", "matching", "pattern", "wildcard"),
    "search_files": ("grep", "search files", "search contents", "find text", "look for", "occurrences"),
    "disk_usage": ("disk usage", "free space", "disk space", "how much space"),
    "write_file": ("write file", "save to file", "create file"),
    "write_bytes": ("write binary", "save bytes", "write raw"),
    "append_file": ("append", "add to file", "append to"),
    "make_dir": ("mkdir", "make directory", "create folder", "create directory"),
    "copy_path": ("copy", "duplicate", "cp "),
    "move_path": ("move", "rename", "relocate", "mv "),
    "delete_path": ("delete", "remove", "erase", "rm ", "unlink", "wipe"),
...
_CLASS = {
    ...
    "read_file": "filesystem read", "read_bytes": "filesystem read", "stat_path": "filesystem read",
    "path_exists": "filesystem read", "list_dir": "filesystem read", "walk_dir": "filesystem read",
    "glob_paths": "filesystem read", "search_files": "filesystem search", "disk_usage": "filesystem read",
    "write_file": "filesystem write", "write_bytes": "filesystem write", "append_file": "filesystem write",
    "make_dir": "filesystem write", "copy_path": "filesystem write", "move_path": "filesystem write",
