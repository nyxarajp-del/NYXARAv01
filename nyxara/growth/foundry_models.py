...
class ModelSpec:
    ...
    # the runtime foundry threads in FoundryConfig.base_model (TinyLlama-1.1B-Chat-v1.0) — the single
    ...
    # Load custom modeling code shipped with the base. TinyLlama (the runtime base, Llama arch) is a native
