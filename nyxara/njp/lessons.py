...
def _english() -> Course:
    ...
    course.exam = [
        ("the horse pushes the cow", _m(subject="horse", verb="push", object="cow")),
        ("a goat cooks a root", _m(subject="goat", verb="cook", object="root",
                                     definite="no")),
        ("the teacher walks", _m(subject="teacher", verb="walk")),
        ("the window is dark", _m(subject="window", verb="is", property="dark")),
        ("a horse is a animal", _m(subject="horse", verb="is", kind="animal")),
        ("the goat does not push the road",
         _m(subject="goat", verb="push", object="road", negated=True)),
        ("the king painted the house",
         _m(subject="king", verb="paint", object="house", temporal="past")),
        ("the cow will clean the field",
         _m(subject="cow", verb="clean", object="field", temporal="future")),
        ("the bird can pull the seed",
         _m(subject="bird", verb="pull", object="seed", modality="possible")),
        ("does the goat clean the table?",
         _m("polar_question", focus="truth", subject="goat", verb="clean", object="table")),
        ("what does the horse count?",
         _m("question", focus="object", subject="horse", verb="count")),
        ("who answers the letter?",
         _m("question", focus="subject", verb="answer", object="letter")),
        ("the farmer gives the king the apple",
         _m(subject="farmer", verb="give", object="apple", recipient="king")),
        ("the cow gives the song to the teacher",
         _m(subject="cow", verb="give", object="song", goal="teacher")),
        ("the goat works on the road", _m(subject="goat", verb="work", location="road")),
        ("the king 's cow pushes the tree",
         _m(subject="cow", verb="push", object="tree", owner="king")),
        ("the horse and the goat clean the window",
         _m(subject="horse", verb="clean", object="window", subject2="goat")),
        ("the wind is louder than the rain",
         _m(subject="wind", verb="is", property="louder", than="rain")),
        ("the goat that pushes the cow counts the seed",
         _m(subject="goat", verb="count", object="seed", rel_verb="push", rel_object="cow")),
        ("the farmer says that the horse pulls the road",
