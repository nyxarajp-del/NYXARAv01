"""NYXARA · nyx/omni.py — she reads her own source and rewrites her slow parts in C (⚙, L-OMNI).
...
1. **measure** — :meth:`observe` takes her own per-faculty latency from ``NyxBrain.think``. The
...
5. **adopt** — :mod:`nyxara.nyx5.autopoiesis` applies the swap, re-runs the check on a *fresh*
...
DEFAULT_PACKAGES = ("nyxara.nyx", "nyxara.mind", "nyxara.cognition", "nyxara.quantum",
                    "nyxara.memory", "nyxara.growth", "nyxara.sim", "nyxara.nyx5")
