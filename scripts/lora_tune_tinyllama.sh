#!/usr/bin/env bash
# =============================================================================
# NYXARA — LoRA-tune TinyLlama-1.1B into her OWN primary brain
# -----------------------------------------------------------------------------
...
# still works). Every training knob is configurable via NYXARA_FOUNDRY__*
...
echo "==> Forging NYXARA's primary brain: LoRA on TinyLlama-1.1B (${GEN} generation(s))"
echo "    (base downloads on first use; install .[foundry] for the real TinyLlama-1.1B)"
