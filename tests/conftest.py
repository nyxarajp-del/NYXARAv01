...
# cloud rung still opts in by setting ``groq_enabled``/``airouter_enabled`` on its own settings
# object (see tests/mind/test_groq_provider.py), which overrides these defaults.
