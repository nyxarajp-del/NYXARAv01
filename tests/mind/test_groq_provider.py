...
Groq is NYXARA's first cloud FALLBACK (the rung behind ``aicredits``) and a SUBORDINATE tool either
way: request in → text out, no persona, no control. These tests use a fake ``openai`` module so nothing
